...
class GoogleCompany(models.Model):
    ...
    STATUS_CHOICES = [
        ...
        ("Call_Back", "Call Back"),
        ("Follow_Up", "Follow Up"),
        ("Call_Back_Weekend", "Call Back Weekend"),
        ("Call_Back_Weekdays", "Call Back Weekdays"),
        ("Visit_On", "Visit On....."),
        ...
        ("Some_Other_Project", "Some other project"),
        ("Low_Budget", "Low Budget"),
        ("RTM_Commercial", "RTM. Commercial"),
        ("Rental_Commercial", "Rental Commercial"),
        ("RTM_Residential", "RTM. Residential"),
        ("Rental_Residential", "Rental Residential"),
        ("Already_Purchased", "All Ready Purchased"),

        # old list items (kept)
        ("Not_received", "Not Received"),
        ("They_Will_Connect", "They Will Connect"),
...
class Comment(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name="realtypms_comment_created_by"
    )
    updated_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name="realtypms_comment_updated_by"
    )
...
class VoiceRecording(models.Model):
    ...
    # ✅ FIXED: uploaded_by related_name unique
    uploaded_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name="realtypms_voicerecording_uploaded_by"
    )
...
class Visit(models.Model):
    ...
    # ✅ FIXED: uploaded_by related_name unique (no clash)
    uploaded_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True, blank=True,
...
class Followup(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name="realtypms_followup_created_by"
    )
    updated_by = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.SET_NULL,
        null=True, blank=True,
        related_name="realtypms_followup_updated_by"
    )
